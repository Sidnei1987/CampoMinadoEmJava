...
public class Tabuleiro {
    ...
    // Faz a contagem para saber se vc achou as 10 minas e assim saber se ganhou 
    ...
    //Função  que abrie a casas do lado que nao tem mina proximas 
    ...
    public int getPosicao(int linha, int coluna){
      ...
      //Onde faz as escolha de linhas e colounas selecionadas  
